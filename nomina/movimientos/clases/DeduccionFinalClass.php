...
final class DeduccionFinal extends Controler{
  ...
  public function Main(){
    ...
    require_once("DeduccionFinalLayoutClass.php");
    require_once("DeduccionFinalModelClass.php");
	
    $Layout = new DeduccionFinalLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model  = new DeduccionFinalModel();
...
$DeduccionFinal = new DeduccionFinal();
