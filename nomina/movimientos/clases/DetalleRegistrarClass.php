...
final class DetalleRegistrar extends Controler{
  ...
  public function Main(){
    ...
    require_once("DetalleRegistrarLayoutClass.php");
    require_once("DetalleRegistrarModelClass.php");
	
    $Layout = new DetalleRegistrarLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model  = new DetalleRegistrarModel();
...
$DetalleRegistrar = new DetalleRegistrar();
