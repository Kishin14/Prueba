<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
  ...
  <body> 
  <input type="hidden" id="liquidacion_vacaciones_id" value="{$liquidacion_vacaciones_id}" />
   <table align="center" id="tableImputaciones" width="98%">
	...
	<tbody>
      ...
      <tr>
        ...
        <td><input type="text" name="descripcion" id="descripcion" value="{$i.desc_vacaciones}" class="text" /></td>		        


        <td class="no_requerido">


          <input type="text" name="base" class="numeric no_requerido"  value="{$i.base_vacaciones}" maxlength="12"  size="15" />        </td>


        <td><input type="text" name="debito" {if $i.debito <0 } class="numeric_negative" {else} class="numeric" {/if} value="{$i.deb_item_vacaciones}" maxlength="15" size="12" /></td>        


        <td><input type="text" name="credito" {if $i.credito <0 } class="numeric_negative" {else} class="numeric" {/if} value="{$i.cre_item_vacaciones}" maxlength="15" size="12" /></td>
   ...
   <!--<table align="center" id="tableDetalleVacaciones" width="98%">
    <thead>
	  ...
	  {foreach name=detalles from=$DETALLES item=i}
          ...
          <tr>
            ...
            <td>       
                ...
                <input type="hidden" name="detalle_liquidacion_vacaciones_id" value="{$i.detalle_liquidacion_vacaciones_id}" class="required" />        
            </td>
