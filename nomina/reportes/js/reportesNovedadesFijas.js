$(document).ready(function(){   
	...
	$("#si_cargo").change(function(){
     ...
     if(ValidaRequeridos(formulario)){
       ...
       var QueryString = "reportesNovedadesFijasClass.php?ACTIONCONTROLER=generateFileexcel&desde="+desde+"&hasta="+hasta+"&si_empleado="+si_empleado+"&empleado_id="+empleado_id+"&rand="+Math.random();
...
function OnclickGenerar(formulario){
	...
	if(ValidaRequeridos(formulario)){
		 var QueryString = "DetallesNovedadesFijasClass.php?"+FormSerialize(formulario);
