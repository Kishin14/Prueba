...
final class reporteEmpleadoLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reporteEmpleadoClass.php","reporteEmpleadoForm","reporteEmpleadoForm");
...
//LISTA MENU
   ...
   public function RenderMain(){   
     $this -> RenderLayout('reporteEmpleado.tpl');	 
   }
}
