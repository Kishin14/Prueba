...
final class CausalEvalLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("CausalEvalClass.php","causalevalForm","CausalEvalForm");
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/parametros_modulo/js/causaleval.js");
     ...
     $this -> assign("CAUSALEVALID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_desempeno_id]));	 
     ...
     $this -> assign("NOTA",			$this -> objectsHtml -> GetobjectHtml($this -> fields[nota]));
    ...
    public function SetGridCausalEval($Attributes,$Titles,$Cols,$Query){
    ...
    public function RenderMain(){
      ...
      $this ->RenderLayout('causaleval.tpl');
