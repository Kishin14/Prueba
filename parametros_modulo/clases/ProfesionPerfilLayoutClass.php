...
final class ProfesionPerfilLayout extends View{
   ...
   public function setProfesionPerfil($ProfesionPerfil){   



     $this -> assign("DETALLES",$ProfesionPerfil);   
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/parametros_modulo/js/ProfesionPerfil.js");
   ...
   public function setProfesiones($profesiones){
      ...
      $this -> assign("PROFESIONES",$profesiones);     
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('ProfesionPerfil.tpl');
