...
final class NovedadLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/parametros_modulo/js/novedad.js");
     ...
     $this -> assign("NOVEDADID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_novedad_id]));	 
