...
final class EstudiosLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("EstudiosClass.php","estudiosForm","EstudiosForm");
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/parametros_modulo/js/estudios.js");
     ...
     $this -> assign("NIVEL_ID",			$this -> objectsHtml -> GetobjectHtml($this -> fields[nivel_escolaridad_id]));	 
    ...
    public function RenderMain(){
      ...
      $this ->RenderLayout('estudios.tpl');
