...
final class TipoVehiculoLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("TipoVehiculoClass.php","tipovehiculoForm","TipoVehiculoForm");
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/parametros_modulo/js/vehiculo.js");
     ...
     $this -> assign("TIPOVEHICULOID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[vehiculo_nomina_id]));	 
	 ...
	 $this -> assign("SERVICIO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[servicio]));
   ...
   if($this -> Borrar)
	 ...
	 public function setCambioTipo($Permiso){
     $this -> CambiarTipo = $Permiso;  
	  $this -> NotaTipo	= $Permiso;
   }
   
    public function SetGridTipoVehiculo($Attributes,$Titles,$Cols,$Query){
