                ...
                <td colspan="3" align="center">
                    <table width="100%">
                        <tr>
                            ...
                            <td width="30%" align="center">{$GENERAR}{$IMPRIMIR}{$LIMPIAR} <input type="button" class="btn btn-primary" name="generar_excel" id="generar_excel" value="Generar Archivo Excel>>" /></td>
                            <td width="20%"></td>
                        </tr>
                    </table>
                </td>
