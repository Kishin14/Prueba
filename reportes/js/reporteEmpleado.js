...
///INICIO VALIDACION FECHAS DE REPORTE
 ...
 $("#generar_excel").click(function(){
     ...
     if(ValidaRequeridos(formulario)){
       ...
       var QueryString = "reporteEmpleadoClass.php?ACTIONCONTROLER=generateFileexcel&desde="+desde+"&hasta="+hasta+
...
function OnclickGenerar(formulario){
	...
	if(ValidaRequeridos(formulario)){
		 var QueryString = "detallesEmpleadoClass.php?"+FormSerialize(formulario);
