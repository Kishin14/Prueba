...
final class reporteHojaVidaModel extends Db{
  ...
  public function getReporte($consulta_cliente,$Conex){ 
		...
		IF(s.escaner_eps!='',CONCAT('','<a href=\"javascript:popPup(\'',s.escaner_eps,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS escaner_eps,
		IF(s.escaner_pension!='',CONCAT('','<a href=\"javascript:popPup(\'',s.escaner_pension,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS escaner_pension,
		IF(s.escaner_arl!='',CONCAT('','<a href=\"javascript:popPup(\'',s.escaner_arl,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS escaner_arl,
		IF(s.escaner_caja!='',CONCAT('','<a href=\"javascript:popPup(\'',s.escaner_caja,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS escaner_caja,
		IF(s.escaner_cesan!='',CONCAT('','<a href=\"javascript:popPup(\'',s.escaner_cesan,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS escaner_cesan,
		IF(s.examen_medico!='',CONCAT('','<a href=\"javascript:popPup(\'',s.examen_medico,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS examen_medico,
		IF(s.salud_ocupacional!='',CONCAT('','<a href=\"javascript:popPup(\'',s.salud_ocupacional,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS salud_ocupacional,
		IF(s.examen_periodico!='',CONCAT('','<a href=\"javascript:popPup(\'',s.examen_periodico,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS examen_periodico,
		IF(s.examen_egreso!='',CONCAT('','<a href=\"javascript:popPup(\'',s.examen_egreso,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS examen_egreso,
		IF(s.cartas_cyc!='',CONCAT('','<a href=\"javascript:popPup(\'',s.cartas_cyc,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS cartas_cyc,
		IF(s.entrega_dotacion!='',CONCAT('','<a href=\"javascript:popPup(\'',s.entrega_dotacion,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS entrega_dotacion,
		IF(s.contrato_firmado!='',CONCAT('','<a href=\"javascript:popPup(\'',s.contrato_firmado,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS contrato_firmado,
		IF(s.foto!='',CONCAT('','<a href=\"javascript:popPup(\'',s.foto,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS foto,
		IF(s.incapacidades!='',CONCAT('','<a href=\"javascript:popPup(\'',s.incapacidades,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS incapacidades,
		IF(s.paz_salvo!='',CONCAT('','<a href=\"javascript:popPup(\'',s.paz_salvo,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS paz_salvo,
		IF(s.certi_procu!='',CONCAT('','<a href=\"javascript:popPup(\'',s.certi_procu,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS certi_procu,
		IF(s.certi_antece!='',CONCAT('','<a href=\"javascript:popPup(\'',s.certi_antece,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS certi_antece,
		IF(s.certi_contralo!='',CONCAT('','<a href=\"javascript:popPup(\'',s.certi_contralo,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS certi_contralo,
		IF(s.certi_liquidacion!='',CONCAT('','<a href=\"javascript:popPup(\'',s.certi_liquidacion,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS certi_liquidacion,
		IF(s.certi_laboral!='',CONCAT('','<a href=\"javascript:popPup(\'',s.certi_laboral,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS certi_laboral
  ...
  public function get_licencia($contrato_id,$Conex){ 
		 ...
		 INACTIVO</span>')AS estado,(SELECT t.nombre FROM tipo_incapacidad t WHERE t.tipo_incapacidad_id=l.tipo_incapacidad_id)AS tipo_incapacidad,IF(l.remunerado=0,'SI','NO')AS remunerado,CONCAT('','<a href=\"\../../../../application/nomina/movimientos/clases/LicenciaClass.php?licencia_id=',l.licencia_id,'\" target=\"_blank\">','<input type=\"button\" class=\"btn btn-info\" value=\"VER LICENCIA\" style=\"padding: 0.055rem 0.55rem\">','</a>' )AS ver,l.diagnostico FROM licencia l WHERE l.contrato_id = $contrato_id ORDER BY l.fecha_inicial ASC";
  ...
  public function get_novedad($contrato_id,$Conex){ 
		 ...
		 ACTIVO</span>','<span style=\'color:#FF0000;\'>
		 INACTIVO</span>')AS estado,CONCAT('','<a href=\"\../../../../application/nomina/movimientos/clases/NovedadClass.php?novedad_fija_id=',n.novedad_fija_id,'\" target=\"_blank\">','<input type=\"button\" class=\"btn btn-info\" value=\"VER NOVEDAD\" style=\"padding: 0.055rem 0.55rem\">','</a>' )AS ver,(SELECT c.descripcion FROM concepto_area c WHERE c.concepto_area_id=n.concepto_area_id)AS concepto_area,IF(n.documento_anexo!='',CONCAT('','<a href=\"javascript:popPup(\'',n.documento_anexo,'\',\'1000\',\'1150\');\">','<img src=\"/application/framework/media/images/forms/visualizar.png\">','</a>' ),'N/A')AS soporte FROM novedad_fija n WHERE n.contrato_id = $contrato_id ORDER BY n.fecha_inicial ASC";
  ...
  public function get_extras($contrato_id,$Conex){ 
		 ...
		 LIQUIDADO</span>' END)AS estado,(SUM(s.vr_horas_diurnas)+SUM(s.vr_horas_nocturnas)+SUM(s.vr_horas_diurnas_fes)+SUM(s.vr_horas_nocturnas_fes)+SUM(s.vr_horas_recargo_noc)+SUM(s.vr_horas_recargo_doc))AS total_valor,(SUM(s.horas_diurnas)+SUM(s.horas_nocturnas)+SUM(s.horas_diurnas_fes)+SUM(s.horas_nocturnas_fes)+SUM(s.horas_recargo_noc)+SUM(s.horas_recargo_doc))AS total_cant,CONCAT('','<a href=\"\../../../../application/nomina/movimientos/clases/ExtrasClass.php?hora_extra_id=',s.hora_extra_id,'\" target=\"_blank\">','<input type=\"button\" class=\"btn btn-info\" value=\"VER HORA EXTRA\" style=\"padding: 0.055rem 0.55rem\">','</a>' )AS ver
  ...
  public function getliquida_cesantias($contrato_id,$Conex){ 
		 ...
		 CONTABILIZADO</span>' END)AS estado,CONCAT('','<a href=\"\../../../../application/nomina/movimientos/clases/CesantiasClass.php?liquidacion_cesantias_id=',lc.liquidacion_cesantias_id,'\" target=\"_blank\">','<input type=\"button\" class=\"btn btn-info\" value=\"IR A LIQUIDACION\" style=\"padding: 0.055rem 0.55rem\">','</a>' )AS ir,
  ...
  public function getliquida_primas($contrato_id,$Conex){ 
	 ...
	 $select = "SELECT lc.*,IF(lc.periodo=1,'PRIMER SEMESTRE','SEGUNDO SEMESTRE')AS periodo,IF(lc.tipo_liquidacion='T','TOTAL','PARCIAL')AS tipo_liquidacion,(CASE WHEN lc.estado='I' THEN '<span style=\'color:#FF0000;\'>
		 INACTIVO</span>' WHEN lc.estado='A' THEN 'ACTIVO' ELSE '<span style=\'color:#008000;\'>
		 CONTABILIZADO</span>' END)AS estado,CONCAT('','<a href=\"\../../../../application/nomina/movimientos/clases/PrimaClass.php?liquidacion_prima_id=',lc.liquidacion_prima_id,'\" target=\"_blank\">','<input type=\"button\" class=\"btn btn-info\" value=\"IR A LIQUIDACION\" style=\"padding: 0.055rem 0.55rem\">','</a>' )AS ir,
		 (CONCAT_WS('','<a href=\"javascript:void(0)\" onClick=\"viewDoc(',lc.encabezado_registro_id,')\">','','<input type=\"button\" class=\"btn btn-info\" value=\"VER LIQUIDACION\" style=\"padding: 0.055rem 0.55rem\"> </a>' )) AS ver
  ...
  public function getliquida_vacacion($contrato_id,$Conex){ 
	 ...
	 $select = "SELECT lc.*,(CASE WHEN lc.estado='I' THEN '<span style=\'color:#FF0000;\'>
		 INACTIVO</span>' WHEN lc.estado='A' THEN 'ACTIVO' ELSE '<span style=\'color:#008000;\'>
		 CONTABILIZADO</span>' END)AS estado,CONCAT('','<a href=\"\../../../../application/nomina/movimientos/clases/VacacionClass.php?liquidacion_vacaciones_id=',lc.liquidacion_vacaciones_id,'\" target=\"_blank\">','<input type=\"button\" class=\"btn btn-info\" value=\"IR A LIQUIDACION\" style=\"padding: 0.055rem 0.55rem\">','</a>' )AS ir,
		 (CONCAT_WS('','<a href=\"javascript:void(0)\" onClick=\"viewDoc(',lc.encabezado_registro_id,')\">','','<input type=\"button\" class=\"btn btn-info\" value=\"VER LIQUIDACION\" style=\"padding: 0.055rem 0.55rem\"> </a>' )) AS ver
