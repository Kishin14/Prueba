...
final class reportesHorasExtras extends Controler{
  ...
  public function __construct(){
   ...
   public function Main(){
    ...
    require_once("reportesHorasExtrasLayoutClass.php");
    require_once("reportesHorasExtrasModelClass.php");
	
    $Layout   = new reportesHorasExtrasLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new reportesHorasExtrasModel();
...
$reportesHorasExtras = new reportesHorasExtras();
