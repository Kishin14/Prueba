...
final class ReporteElectronicaLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("ReporteElectronicaClass.php","ReporteElectronicaForm","ReporteElectronicaForm");
     ...
     $this -> TplInclude -> IncludeJs("../js/ReporteElectronica.js"); 
...
/*   public function setOficinas($oficinas){
   ...
   public function RenderMain(){   
     $this -> RenderLayout('ReporteElectronica.tpl');	 
   }
}
