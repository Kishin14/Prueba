...
final class DetallesindicadoresEnfermedadesModel extends Db{
  ...
  public function getReporte2($desde,$hasta,$tipo,$Conex){ 
  ...
  public function getReporte3($desde,$hasta,$tipo,$Conex){ 
  ...
  public function getReporte4($desde,$hasta,$tipo,$Conex){ 
