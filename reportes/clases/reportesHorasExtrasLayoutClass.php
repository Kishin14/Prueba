...
final class reportesHorasExtrasLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reportesHorasExtrasClass.php","reportesHorasExtrasForm","reportesHorasExtrasForm");
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/reportes/js/reportesHorasExtras.js"); 
