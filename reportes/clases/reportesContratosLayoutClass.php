...
final class reportesContratosLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reportesContratosClass.php","reportesContratosForm","reportesContratosForm");
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/reportes/js/reportesContratos.js"); 
...
/*   public function setOficinas($oficinas){
   ...
   public function RenderMain(){   
     $this -> RenderLayout('reportesContratos.tpl');	 
   }
}
