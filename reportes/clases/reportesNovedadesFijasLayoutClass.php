...
final class reportesNovedadesFijasLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reportesNovedadesFijasClass.php","reportesNovedadesFijasForm","reportesNovedadesFijasForm");
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/reportes/js/reportesNovedadesFijas.js"); 
...
/*   public function setOficinas($oficinas){
   ...
   public function RenderMain(){   
     $this -> RenderLayout('reportesNovedadesFijas.tpl');	 
   }
}
