<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
  ...
  <body> 
  <input type="hidden" id="liquidacion_int_int_cesantias_id" value="{$liquidacion_int_int_cesantias_id}" />
   <table align="center" id="tableImputaciones" width="98%">
	...
	<tbody>
      ...
      <tr>
        ...
        <input type="hidden" name="detalle_int_int_cesantias_puc_id" value="{$i.detalle_int_int_cesantias_puc_id}" />        </td>
        ...
        <td><input type="text" name="descripcion" id="descripcion" value="{$i.desc_int_int_cesantias}" class="text" /></td>		        


        <td class="no_requerido">


          <input type="text" name="base" class="numeric no_requerido"  value="{$i.base_int_int_cesantias}" maxlength="12"  size="15" />        </td>


        <td><input type="text" name="debito"  class="numeric"  value="{$i.deb_item_int_int_cesantias}" maxlength="15" size="12" /></td>        


        <td><input type="text" name="credito" class="numeric" value="{$i.cre_item_int_int_cesantias}" maxlength="15" size="12" /></td>
      ...
      <tr>
        ...
        <input type="hidden" name="detalle_int_int_cesantias_puc_id" value="" />        </td>
   ...
   <!--<table align="center" id="tableDetalleIntCesantias" width="98%">
    <thead>
	  ...
	  {foreach name=detalles from=$DETALLES item=i}
          ...
          <tr>
            ...
            <td>       
                ...
                <input type="hidden" name="detalle_liquidacion_int_int_cesantias_id" value="{$i.detalle_liquidacion_int_int_cesantias_id}" class="required" />        
            </td>
