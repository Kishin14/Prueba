...
final class DetalleCesantiasLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/DetalleCesantias.js");
     ...
     $this -> assign("liquidacion_cesantias_id",  		  $_REQUEST['liquidacion_cesantias_id']);	 
	
   }

   public function RenderMain(){
   
        $this -> RenderLayout('DetalleCesantias.tpl');
