  ...
  <table id="tableRegistrar" width="99%">
   <thead>
    ...
    <tr>
        ...
        <th align="right"><input type="text" autocomplete="off" name="{$d.campo}" id="{$d.campo}" style="text-align:right; background:#DAEAF6;" value="{$d.valor}" class="required numeric" /></th>
    ...
    <tr>
     ...
     <td style="display:none;"><input type="text" autocomplete="off" name="debito" id="debito" value="{$d.debito}" class="required numeric" /></td>          
     <td><input type="text" autocomplete="off" name="periodo" id="periodo" value="{$d.periodo}" size="30" class="required" /></td>
     <td style="display:none;"><input type="text" autocomplete="off" name="credito" id="credito" value="{$d.credito}" class="required numeric" /> </td>
