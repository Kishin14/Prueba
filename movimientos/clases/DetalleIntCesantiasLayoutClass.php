...
final class DetalleIntCesantiasLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/DetalleIntCesantias.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('DetalleIntCesantias.tpl');
