...
final class DetallePatronalesLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/detallePatronales.js");
     $this -> TplInclude -> IncludeJs("/application/framework/js/colResizable-1.3.min.js");
	  	  
     $this -> assign("CSSSYSTEM",  $this -> TplInclude -> GetCssInclude());
     $this -> assign("JAVASCRIPT", $this -> TplInclude -> GetJsInclude());
     $this -> assign("LIQUIDACIONNOVID",$_REQUEST['liquidacion_patronal_id']);	 
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('detallePatronales.tpl');
