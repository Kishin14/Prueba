...
final class IntCesantiasModel extends Db{
  ...
  public function comprobar_estado($liquidacion_int_cesantias_id,$Conex){
    				
   $select = "SELECT l.estado, l.si_empleado,l.encabezado_registro_id,l.liquidacion_int_cesantias_id, l.encabezado_registro_id,l.fecha_liquidacion,
			...
			WHERE l.liquidacion_int_cesantias_id=$liquidacion_int_cesantias_id";
	...
	public function Save($Campos,$oficina_id,$usuario_id,$Conex){	
		...
		puc_ventas_cesantias_id,(SELECT naturaleza FROM puc WHERE puc_id = puc_int_cesantias_prov_id) as natu_puc_ventas_cesantias,
		puc_produ_cesantias_id,(SELECT naturaleza FROM puc WHERE puc_id = puc_int_cesantias_prov_id) as natu_puc_produ_cesantias,
		tipo_documento_id
		FROM parametros_liquidacion_nomina WHERE oficina_id=$oficina_id";
		$result_parametros = $this -> DbFetchAll($select_parametros,$Conex); 
		
		$puc_provision_cesantias = $result_parametros[0]['puc_int_cesantias_prov_id'];	$natu_puc_provision_cesantias = $result_parametros[0]['natu_puc_int_cesantias_prov'];
		$puc_consolidado_cesantias = $result_parametros[0]['puc_int_cesantias_cons_id'];$natu_puc_consolidado_cesantias = $result_parametros[0]['natu_puc_int_cesantias_cons'];
		...
		VALUES
		($liquidacion_int_cesantias_id,$puc_consolidado_cesantias,$tercero_id,$numero_identificacion,$digito_verificacion,$centro_de_costo_id,IF($centro_de_costo_id>0,(SELECT codigo FROM centro_de_costo WHERE centro_de_costo_id = $centro_de_costo_id),'NULL'),0,'NULL','NULL',$observaciones,$debito,$credito,$valor_consolidado,0)";
		...
		if($valor_diferencia!=0){
			...
			if($valor_diferencia>0){
				$insert_det_puc_prov ="INSERT INTO detalle_int_cesantias_puc (liquidacion_int_cesantias_id,puc_id,tercero_id,numero_identificacion,centro_de_costo_id,codigo_centro_costo,base_int_cesantias,porcentaje_int_cesantias,formula_int_cesantias,desc_int_cesantias,deb_item_int_cesantias,cre_item_int_cesantias,valor_liquida,contrapartida)
				VALUES
				($liquidacion_int_cesantias_id,$puc_diferencia,$tercero_id,$numero_identificacion,$centro_de_costo_id,IF($centro_de_costo_id>0,(SELECT codigo FROM centro_de_costo WHERE centro_de_costo_id = $centro_de_costo_id),'NULL'),0,'NULL','NULL',$observaciones,$valor_diferencia,0,0,0)";
				...
				$insert_det_puc_prov ="INSERT INTO detalle_int_cesantias_puc (liquidacion_int_cesantias_id,puc_id,tercero_id,numero_identificacion,centro_de_costo_id,codigo_centro_costo,base_int_cesantias,porcentaje_int_cesantias,formula_int_cesantias,desc_int_cesantias,deb_item_int_cesantias,cre_item_int_cesantias,valor_liquida,contrapartida)
				VALUES
				($liquidacion_int_cesantias_id,$puc_diferencia,$tercero_id,$numero_identificacion,$centro_de_costo_id,IF($centro_de_costo_id>0,(SELECT codigo FROM centro_de_costo WHERE centro_de_costo_id = $centro_de_costo_id),'NULL'),0,'NULL','NULL',$observaciones,0,ABS($valor_diferencia),0,0)";
				$this -> query($insert_det_puc_prov,$Conex,true); 
		...
		VALUES
		($liquidacion_int_cesantias_id,$puc_contrapartida,$tercero_id_cesan,$numero_identificacion_cesan,$digito_verificacion_cesan,$centro_de_costo_id,IF($centro_de_costo_id>0,(SELECT codigo FROM centro_de_costo WHERE centro_de_costo_id = $centro_de_costo_id),'NULL'),0,'NULL','NULL',$observaciones,0,$valor_liquidacion,0,1)";
		$this -> query($insert_det_puc_contra,$Conex,true);
		
		$this -> Commit($Conex);  
		
		
		return $liquidacion_int_cesantias_id;
	...
	public function saveTodos($si_empleado,$area_laboral,$centro_de_costo_id,$tercero_id,$numero_identificacion,$tercero_id_cesan,$numero_identificacion_cesan,$fecha_liquidacion,$fecha_corte,$fecha_ultimo_corte,$beneficiario,$contrato_id,$empleado_id,$salario,$dias_corte,$valor_liquidacion,$dias_no_remu,$dias_liquidacion,$valor_consolidado,$valor_diferencia,$fecha_inicio,$tipo_liquidacion,$observaciones,$oficina_id,$usuario_id,$Conex){
		...
		$insert_cesantias = "INSERT INTO liquidacion_int_cesantias 
		(liquidacion_int_cesantias_id,fecha_liquidacion,fecha_corte,fecha_ultimo_corte,beneficiario,contrato_id,empleado_id,salario,fecha_inicio_contrato,estado,dias_periodo,dias_no_remu,dias_liquidados,valor_consolidado,valor_liquidacion,valor_diferencia,tipo_liquidacion,observaciones,si_empleado,usuario_id,fecha_registro)	VALUES
		($liquidacion_int_cesantias_id,'$fecha_liquidacion','$fecha_corte','$fecha_ultimo_corte','$beneficiario',$contrato_id,$empleado_id,$salario,'$fecha_inicio','A',$dias_corte,$dias_no_remu,$dias_liquidacion,$valor_consolidado,$valor_liquidacion,$valor_diferencia,'$tipo_liquidacion','$observaciones','$si_empleado',$usuario_id,'$fecha_registro')";

		$this -> query($insert_cesantias,$Conex,true);
		
		
		$select_parametros="SELECT 
		puc_int_cesantias_prov_id,puc_int_cesantias_cons_id,puc_int_cesantias_contra_id,puc_admon_cesantias_id,puc_ventas_cesantias_id,puc_produ_cesantias_id,tipo_documento_id
		FROM parametros_liquidacion_nomina WHERE oficina_id=$oficina_id";
		$result_parametros = $this -> DbFetchAll($select_parametros,$Conex); 
		
		if(!count($result_parametros)>0) exit("No se han configurado los parametros para la oficina!! ");
		
		$puc_provision_cesantias = $result_parametros[0]['puc_int_cesantias_prov_id'];
		$puc_consolidado_cesantias = $result_parametros[0]['puc_int_cesantias_cons_id'];
		$puc_contrapartida		  = $result_parametros[0]['puc_int_cesantias_contra_id'];
		...
		$insert_det_puc_cons ="INSERT INTO detalle_int_cesantias_puc (liquidacion_int_cesantias_id,puc_id,tercero_id,numero_identificacion,centro_de_costo_id,codigo_centro_costo,base_int_cesantias,porcentaje_int_cesantias,formula_int_cesantias,desc_int_cesantias,deb_item_int_cesantias,cre_item_int_cesantias,valor_liquida,contrapartida)	VALUES
		($liquidacion_int_cesantias_id,$puc_consolidado_cesantias,$tercero_id,$numero_identificacion,$centro_de_costo_id,IF($centro_de_costo_id>0,(SELECT codigo FROM centro_de_costo WHERE centro_de_costo_id = $centro_de_costo_id),'NULL'),0,'NULL','NULL','$observaciones',$valor_consolidado,0,0,0)";
		$this -> query($insert_det_puc_cons,$Conex,true); 
		...
		$insert_det_puc_contra ="INSERT INTO detalle_int_cesantias_puc (liquidacion_int_cesantias_id,puc_id,tercero_id,numero_identificacion,centro_de_costo_id,codigo_centro_costo,base_int_cesantias,porcentaje_int_cesantias,formula_int_cesantias,desc_int_cesantias,deb_item_int_cesantias,cre_item_int_cesantias,valor_liquida,contrapartida)
		VALUES	($liquidacion_int_cesantias_id,$puc_contrapartida,$tercero_id_cesan,$numero_identificacion_cesan,$centro_de_costo_id,IF($centro_de_costo_id>0,(SELECT codigo FROM centro_de_costo WHERE centro_de_costo_id = $centro_de_costo_id),NULL),0,NULL,NULL,'$observaciones',0,$valor_liquidacion,0,1)";
		$this -> query($insert_det_puc_contra,$Conex,true);
	...
	public function ValidateRow($Conex,$Campos){
		...
		$Data = new ValidateRow($Conex,"liquidacion_int_cesantias",$Campos);
		return $Data -> GetData();
	}
	...
	public function getContabilizarReg($liquidacion_int_cesantias_id,$empresa_id,$oficina_id,$usuario_id,$mesContable,$periodoContable,$Conex){
		...
		FROM liquidacion_int_cesantias l WHERE l.liquidacion_int_cesantias_id=$liquidacion_int_cesantias_id";	
		$result 	= $this -> DbFetchAll($select,$Conex,true); 
  ...
  public function getContabilizarRegT($liquidacion_int_cesantias_id,$fecha_liquidacion,$empresa_id,$oficina_id,$usuario_id,$mesContable,$periodoContable,$Conex){//contabilizar varios aca
	...
	$this -> Begin($Conex);
		...
		$select 	= "SELECT f.*,
					...
					FROM liquidacion_int_cesantias f 
		...
		$id_documento_fuente	= $result[0]['liquidacion_int_cesantias_id'];
		...
		for($i=0;$i<count($result);$i++){ 
			...
			$liquidacion_int_cesantias_id1 = $result[$i]['liquidacion_int_cesantias_id'];
			$select_item      = "SELECT *  
			FROM   detalle_int_cesantias_puc WHERE liquidacion_int_cesantias_id=$liquidacion_int_cesantias_id1";
			...
			foreach($result_item as $result_items){  
				...
				$insert_item ="INSERT INTO imputacion_contable (imputacion_contable_id,tercero_id,numero_identificacion,digito_verificacion,puc_id,descripcion,encabezado_registro_id,centro_de_costo_id,codigo_centro_costo,valor,base,	porcentaje,formula,debito,credito)
								SELECT  $imputacion_contable_id,tercero_id,numero_identificacion,digito_verificacion,puc_id,desc_int_cesantias,$encabezado_registro_id,centro_de_costo_id,codigo_centro_costo,(deb_item_int_cesantias+cre_item_int_cesantias),base_int_cesantias,porcentaje_int_cesantias,
								formula_int_cesantias,deb_item_int_cesantias,cre_item_int_cesantias
								FROM detalle_int_cesantias_puc WHERE liquidacion_int_cesantias_id=$liquidacion_int_cesantias_id1 AND detalle_int_cesantias_puc_id=$result_items[detalle_int_cesantias_puc_id]"; 
			...
			$update = "UPDATE liquidacion_int_cesantias SET encabezado_registro_id=$encabezado_registro_id,	
					...
					WHERE liquidacion_int_cesantias_id='$liquidacion_int_cesantias_id1'  AND estado='A'";	
	...
	public function selectDatosLiquidacionId($liquidacion_int_cesantias_id,$Conex){
		...
		FROM liquidacion_int_cesantias lv, empleado em, tercero t 
		WHERE lv.liquidacion_int_cesantias_id = $liquidacion_int_cesantias_id AND em.empleado_id=lv.empleado_id AND t.tercero_id=em.tercero_id"; 
	...
	public function getValor($empleado_id,$fecha_ultimo_corte,$fecha_corte,$dias_periodo,$oficina_id,$Conex){
		...
		$valor_cesan = intval(($base_liquidacion*$dias_liquidacion)/360);
		$valor_liquidacion = intval((($valor_cesan * 0.12) * $dias_liquidacion) / 360);//aca
  ...
  public function cancellation($liquidacion_int_cesantias_id,$encabezado_registro_id,$causal_anulacion_id,$observacion_anulacion,$usuario_anulo_id,$Conex){
  
   $this -> Begin($Conex);
  
     $update = "UPDATE liquidacion_int_cesantias SET estado = 'I',causal_anulacion_id = $causal_anulacion_id,observacion_anulacion = $observacion_anulacion,
	 fecha_anulacion = NOW(),usuario_anulo_id = $usuario_anulo_id WHERE liquidacion_int_cesantias_id = $liquidacion_int_cesantias_id";
	 $this -> query($update,$Conex,true);
  ...
  public function cancellation1($liquidacion_int_cesantias_id,$encabezado_registro_id,$fecha_liquidacion,$causal_anulacion_id,$observacion_anulacion,$usuario_anulo_id,$Conex){
