...
final class DetLiqFinSal extends Controler{
  ...
  public function Main(){
    ...
    require_once("DetLiqFinSalLayoutClass.php");
    require_once("DetLiqFinSalModelClass.php");
	
    $Layout = new DetLiqFinSalLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model  = new DetLiqFinSalModel();
