...
final class DetLiqFinInm extends Controler{
  ...
  public function Main(){
    ...
    require_once("DetLiqFinInmLayoutClass.php");
    require_once("DetLiqFinInmModelClass.php");
	
    $Layout = new DetLiqFinInmLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model  = new DetLiqFinInmModel();
