...
final class CesantiasLayout extends View{
   ...
   public function SetGuardar($Permiso){
    ...
    public function setLiq_CesantiasFrame($liquidacion_cesantias_id){

	 $this -> fields[liquidacion_cesantias_id]['value'] = $liquidacion_cesantias_id;

     $this -> assign("CONSECUTIVO",$this -> objectsHtml -> GetobjectHtml($this -> fields[liquidacion_cesantias_id]));	  	   
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("CesantiasClass.php","CesantiasForm","CesantiasForm");
     ...
     $this -> TplInclude -> IncludeJs("../../../nomina/movimientos/js/Cesantias.js");
   ...
   public function setCausalesAnulacion($causales){
    ...
    public function RenderMain(){
      $this ->RenderLayout('Cesantias.tpl');
    }
}
