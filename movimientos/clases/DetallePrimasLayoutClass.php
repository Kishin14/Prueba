...
final class DetallePrimasLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/DetallePrimas.js");
     ...
     $this -> assign("liquidacion_prima_id",  		  $_REQUEST['liquidacion_prima_id']);	 
	
   }

   public function RenderMain(){
   
        $this -> RenderLayout('DetallePrimas.tpl');
