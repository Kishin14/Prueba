...
final class SalarioFinalLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/SalarioFinal.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('SalarioFinal.tpl');
