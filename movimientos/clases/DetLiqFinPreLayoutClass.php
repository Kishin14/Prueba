...
final class DetLiqFinPreLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/framework/js/funcionesDetalle.js");
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/DetLiqFinPre.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('DetLiqFinPre.tpl');
