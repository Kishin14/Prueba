...
final class DetalleRegistrarLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/application/nomina/movimientos/js/detalle_registrar.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('detalleRegistrar.tpl');
